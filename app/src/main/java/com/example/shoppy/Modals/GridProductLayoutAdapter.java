...
public class GridProductLayoutAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            ImageView productImg = view.findViewById(R.id.hs_product_img);
            ...
            Glide.with(parent.getContext()).load(horizontalProductScrollModelList.get(position).getProductImg())
